...
//对应原github库：com.github.donkingliang:LabelsView
...
//            }
    ...
    public void setLabelTextWidth(int labelWidth) {
        if(mLabelWidth != labelWidth) {
            mLabelWidth = labelWidth;
            int count = getChildCount();
            for(int i = 0; i < count; i++) {
                TextView label = (TextView) getChildAt(i);
                LayoutParams layoutParams = label.getLayoutParams();
