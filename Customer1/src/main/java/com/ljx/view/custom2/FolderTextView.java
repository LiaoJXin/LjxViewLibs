...
//https://blog.csdn.net/tanxuewe/article/details/50793630
public class FolderTextView extends AppCompatTextView {
    ...
    public FolderTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int defaultColor = ContextCompat.getColor(context, R.color.color0E6CCB);
        foldTxColor = a.getColor(R.styleable.FolderTextView_foldTxColor, defaultColor);
        a.recycle();
    }
    ...
    public int getFoldTxColor() {
        return foldTxColor;
    }

    public void setFoldTxColor(int foldTxColor) {
        this.foldTxColor = foldTxColor;
    }
